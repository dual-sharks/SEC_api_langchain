...
class SecApiToolInput(BaseModel):
    """Input schema for SecApi tool.
...
class SecApiTool(BaseTool):  # type: ignore[override]
    """SecApi tool.

    Setup:
        # TODO: Replace with relevant packages, env vars.
        Install ``langchain-sec-api`` and set environment variable ``SECAPI_API_KEY``.

        .. code-block:: bash

            pip install -U langchain-sec-api
    ...
    args_schema: Type[BaseModel] = SecApiToolInput
